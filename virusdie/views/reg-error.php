...
<div class="vd-container">
	<div class="vd-scanner">
		<div class="vd-scanner__container">
			...
			<p class="vd-scanner__text">We can't find your account in Virusdie.Cloud.
				You can create the new account via the link below or go back to authorization page and input a correct email.</p>
