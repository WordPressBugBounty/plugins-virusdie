...
<div class="vd-container">
	<div class="vd-scanner">
		<div class="vd-scanner__container">
			...
			<p class="vd-scanner__text">The sync error detected.
				That means Virusdie can’t connect to your website’ plugin to run website scan and other security tools.</p>
