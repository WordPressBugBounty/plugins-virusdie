...
<div class="vd-mainBlock">
	<div class="vd-mainBlock__block --big">
		...
		<div class="vd-mainBlock__col --small">
			<div class="vd-mainBlock__share-block">
				<div class="vd-mainBlock__share-users">
					<img src="assets/img/46.jpeg" class="vd-mainBlock__share-user">
					<img src="assets/img/95.jpeg" class="vd-mainBlock__share-user">
					<img src="assets/img/6MWH9Xi_.jpeg" class="vd-mainBlock__share-user">
				</div>
				<div class="vd-mainBlock__share-box">
					<span class="vd-mainBlock__share-info">Share for 3 users</span>
					<a href="" class="vd-mainBlock__share-add">Add user</a>
				</div>
			</div>
		</div>
		*/ ?>
	...
	<div class="vd-mainBlock__plan --yellow">
		<div class="vd-mainBlock__plan-header">
			<span class="vd-mainBlock__plan-title">Free Plan</span>
			<a href="<?php echo $vd_user->getDashboardLink(); ?>&r=<?php echo constant('VDWS_VIRUSDIE_SITE_PANEL'); ?>/billing" class="vd-btn --black --small" target="_blank">Buy premium $15<sub>/MO</sub></a>
		</div>
		<p class="vd-mainBlock__plan-text">
			Now you can scan site just once a month. Plus just a basic monitoring available.
			<a href="<?php echo constant('VDWS_VIRUSDIE_SITE_LANDING'); ?>/pricing/" class="vd-learn-more --black --inline --mobile-br" target="_blank">Compare plans</a>
		</p>
	</div>
</div>
		...
		<div class="vd-antivirus">
			...
			<div class="vd-antivirus__upgrade-block">
				<p class="vd-antivirus__upgrade-text">
					Free Antivirus scans your website one a month. Buy Premium to get daily scans and automatic cleanup.
				</p>
				<div class="vd-antivirus__upgrade-row">
					<a href="<?php echo $vd_user->getDashboardLink(); ?>&r=<?php echo constant('VDWS_VIRUSDIE_SITE_PANEL'); ?>/billing" class="vd-btn --outline-green --small" target="_blank">
						Upgrade Plan
					</a>
					<a href="<?php echo constant('VDWS_VIRUSDIE_SITE_LANDING'); ?>/faq/antivirus/" class="vd-learn-more --ml-16 --black --inline" target="_blank">
						Learn more
					</a>
				</div>
			</div>
		...
		<div class="vd-patchmanager">
			...
			<div class="vd-patchmanager__upgrade-block">
				<p class="vd-patchmanager__upgrade-text">
					Buy Premium to get website hardening - a virtual and real patch management for vulnerabilities.
				</p>
				<div class="vd-patchmanager__upgrade-row">
					<a href="<?php echo $vd_user->getDashboardLink(); ?>&r=<?php echo constant('VDWS_VIRUSDIE_SITE_PANEL'); ?>/billing" class="vd-btn --outline-green --small" target="_blank">
						Upgrade Plan
					</a>
					<a href="<?php echo constant('VDWS_VIRUSDIE_SITE_LANDING'); ?>/faq/patchmanager/" class="vd-learn-more --ml-16 --black --inline" target="_blank">
						Learn more
					</a>
				</div>
			</div>
		...
		<div class="vd-fwall">
			...
			<div class="vd-fwall__upgrade-block">
				<p class="vd-fwall__upgrade-text">
					The Firewall works in free mode and just detect attacks. Upgrade your plan to activate protection.
				</p>
				<div class="vd-fwall__upgrade-row">
					<a href="<?php echo $vd_user->getDashboardLink(); ?>&r=<?php echo constant('VDWS_VIRUSDIE_SITE_PANEL'); ?>/billing" class="vd-btn --outline-green --small" target="_blank">
						Upgrade Plan
					</a>
					<a href="<?php echo constant('VDWS_VIRUSDIE_SITE_LANDING'); ?>/faq/firewall/" class="vd-learn-more --ml-16 --black --inline" target="_blank">
						Learn more
					</a>
				</div>
			</div>
					...
					<a href="<?php echo $vd_user->getDashboardLink(); ?>&r=<?php echo constant('VDWS_VIRUSDIE_SITE_PANEL'); ?>/websites%23quick_SIDEBAR:<?php echo intval($vd_site->getId()) . '/FIREWALL_TAB/FIREWALL_DAILY:' . date('Ymd', intval($vd_site->lastScan())); ?>" class="vd-report" target="_blank">
						<div class="vd-report__col">
							<div class="vd-report__item-box">
								...
								<span class="vd-report__title"><?php echo VDWS_VirusdieMessages::getTextMessage('fw_status_f'); ?></span>
							</div>
